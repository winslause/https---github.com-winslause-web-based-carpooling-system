...
<body style="background-color:#242852">
  <div style="background-color:#242852" class="container">
    <form action='<?php echo $_SERVER['PHP_SELF'] ?>' method='POST' style="margin-top: 40px;">
      <div class="price">
        <h1 style="margin-top:10px">Pay for your booking</h1> <!-- For testing purposes, we have added the amount manually. This should proceed from your website -->
      </div>
      <div class="card__container" style="background-color:#242852">
        <div class="card" style="background-color:#242852">
          <div class="row">
            <img src="wens.jpg" style="width:30%;margin: 0 35%;">
          ...
          <div class="row number" style="background-color:#fff; color:black;">
            <div class="info">
              ...
              <input style="color:black;" id="cardnumber" type="text" name="phone_number" maxlength="10" placeholder="0700000000" />
            </div>
          </div>
        </div>
      </div>
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;"></p>
  </div>
  <center style="color:white">
    <button class="btn btn-light" ><a href="../payment.php">Other payment options </a></button>
    <button class="btn btn-secondary"><a href="../my-booking.php">See your bookings</a></button>
  </center><br>
