...
$config = array(
    ...
    "key"              => "cXy6AMWkuCUSHaL3cqA6eEOWxzhcgTZR", //Enter your consumer key here
    "secret"           => "mFWCOC5sog2DGiXt", //Enter your consumer secret here
    "username"         => "testapi",
    "TransactionType"  => "CustomerPayBillOnline",
    "passkey"          => "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919", //Enter your passkey here
    "CallBackURL"      => "https://mydomain.com/mpesa/callback.php", //When using localhost, Use Ngrok to forward the response to your Localhost
    "AccountReference" => "CompanyXLTD",
    "TransactionDesc"  => "Payment of X" ,
);


// $mon = "SELECT price from tblvehicles where id = id";
// $intvar = (int)filter_var($mon, FILTER_SANITIZE_NUMBER_INT);
// require "../vehical-details.php";
// $mon = $result->price;
