									...
									<div id="print">
										<table border="1" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
											...
											<tbody>
												...
												<?php
												$bid = intval($_GET['bid']);
												$sql = "SELECT tblusers.*,tblroutes.routeName,tblvehicles.VehicleTitle,tblbooking.fDate,tblbooking.fTime,tblbooking.message,tblbooking.VehicleId as vid,tblbooking.Status,tblbooking.PostingDate,tblbooking.id,tblbooking.BookingNumber,tblvehicles.price
									  from tblbooking join tblvehicles on tblvehicles.id=tblbooking.VehicleId join tblusers on tblusers.EmailId=tblbooking.userEmail join tblroutes on tblvehicles.routename=tblroutes.id where tblbooking.id=:bid";
												$query = $dbh->prepare($sql);
