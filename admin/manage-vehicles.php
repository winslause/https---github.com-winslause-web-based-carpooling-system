								...
								<div class="panel-body">
									...
									<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
										...
										<tbody>
											...
											<?php
											$sql = "SELECT tblvehicles.VehicleTitle,tblroutes.routeName,tblvehicles.seats,tblvehicles.freeseats,tblvehicles.price,tblvehicles.picktime from tblvehicles join tblroutes on tblroutes.id = tblvehicles.routename";
											$query = $dbh->prepare($sql);
											$query->execute();
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {				?>
													<tr>
														...
														<td><?php echo htmlentities($result->freeseats); ?></td>
														<td><?php echo htmlentities($result->price); ?></td>
														<td><?php echo htmlentities($result->picktime); ?></td>
