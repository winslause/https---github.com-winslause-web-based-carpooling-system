	<nav class="ts-sidebar" style="background-color:gray">
		<ul class="ts-sidebar-menu">

			<li class="ts-label">Main</li>
			<li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>

			<li><a href="#"><i class="fa fa-files-o"></i> Routes</a>
				<ul>
					<li><a href="create-brand.php">Create Route</a></li>
					<li><a href="manage-brands.php">Manage Routes</a></li>
				</ul>
			</li>
